...
class CDirectXCylinder : public CDirectX12
{
public:
	CDirectXCylinder();
	virtual ~CDirectXCylinder();
...
protected:
	...
	int m_iVertexColCount = 8;
	int m_iVertexRowCount = 5;
	float m_fVertexRadius = 0.5;
	float m_fVertexRowHeight = 0.25;
};
